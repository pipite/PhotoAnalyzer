...
public:
	...
	__property bool IsInGroup = {read = GetIsInGroup};
};
...
public:
	...
	__property bool IsExpanded = {read = PIsExpanded, write = SetIsExpanded};
...
public:
	...
	void      __fastcall G3DDragOver(TObject *Sender, const TDragObject &Data, const TPointF &Point, TDragOperation &Operation);
